...
class Product {
  ...
  addProduct = (req, res) => {
    try {
      ...
      new Promise((resolve, reject) => {
        let q =
          "INSERT INTO `products`(`product_id`, `name`, `size`, `material`, `category`, `description`, `product_stock`, `image`, `selling_price`, `purchase_price`) VALUES (?,?,?,?,?,?,?,?,?,?)";
        db.query(
          q,
          [
            uniqid(),
  ...
  updateProduct = (req, res) => {
    try {
      ...
      new Promise((resolve, reject) => {
        ...
        let q =
          "UPDATE `products` SET `name`=?,`size`=?,`material`=?,`category`=?,`description`=?,`product_stock`=?," +
          ts +
